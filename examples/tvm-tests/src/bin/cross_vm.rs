...
//!
//! ```sh
//! cargo run -p tvm-tests -- validate counter.cross-vm.toml
//! cargo run -p tvm-tests -- run counter.cross-vm.toml --profile smoke
//! ```
//!
...
use tvm_tests::counter::{counter_config_setup, counter_harness};
