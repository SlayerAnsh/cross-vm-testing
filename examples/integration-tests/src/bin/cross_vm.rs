...
//! e.g. `examples/integration-tests/vault.cross-vm.toml`.
//!
//! ```sh
//! cargo run -p cross-vm-integration-tests --bin cross-vm -- validate vault.cross-vm.toml
//! cargo run -p cross-vm-integration-tests --bin cross-vm -- run vault.cross-vm.toml --profile smoke
//! ```
//!
