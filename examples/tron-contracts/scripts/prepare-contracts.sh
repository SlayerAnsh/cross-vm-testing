...
#
# Why this exists:
#   - The example contracts live under examples/solidity-contracts/src/ and are built with
...
#     matching the `--skip "*.t.sol"` convention in solidity-contracts/Makefile.
...
src_dir="$tron_dir/../solidity-contracts/src"
