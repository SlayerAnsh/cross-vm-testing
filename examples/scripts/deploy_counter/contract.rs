...
use crate::artifacts::{evm_counter, COUNTER_WASM};
...
impl Counter {
    ...
    async fn cw_increment(&self, wallet: &str) -> Result<AppResponse<()>, CrossVmError> {
        // Typed handle generated by `CwExecuteFns` (counter's `cross-vm` feature).
        use counter::ExecuteMsgFns;
        let raw = self
            .base
            .cosmwasm()?
